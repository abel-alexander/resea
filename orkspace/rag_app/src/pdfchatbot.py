...
class PDFChatBot:
    ...
    def load_tokenizer(self,token):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(self.config.get("autoTokenizer"),
                                                       token=token,
                                                       # use_auth_token=self.config.get("token")
                                                       # token="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"
                                                      )
    ...
    def create_pipeline(self,token):
        """
    ...
    def process_file(self, file):
        ...
        self.load_vectordb()
        self.load_tokenizer(self.config.get("token"))
        self.load_model(self.config.get("token"))
        self.create_pipeline(self.config.get("token"))
        self.create_chain()
